defmodule PassageParserTest do
  ...
  test "should parse any single-verse passage" do
  ...
  test "should parse any irregular single-verse passage" do
    assert PassageParser.parse("Jn 3:16") == %{book: "Jn", chapter: 3, verse_start: 16}
  end

  test "should not parse when missing book" do
    assert PassageParser.parse("123") == "Invalid passage"
  end
end
